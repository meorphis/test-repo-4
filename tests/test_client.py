...
from meorphis_test_11 import MeorphisTest11, AsyncMeorphisTest11, APIResponseValidationError
from meorphis_test_11._client import MeorphisTest11, AsyncMeorphisTest11
from meorphis_test_11._models import BaseModel, FinalRequestOptions
from meorphis_test_11._constants import RAW_RESPONSE_HEADER
from meorphis_test_11._exceptions import (
    APIStatusError,
    APITimeoutError,
    MeorphisTest11Error,
    APIResponseValidationError,
)
from meorphis_test_11._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MeorphisTest11 | AsyncMeorphisTest11) -> int:
...
class TestMeorphisTest11:
    client = MeorphisTest11(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_11/_legacy_response.py",
                        "meorphis_test_11/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_11/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest11Error):
            client2 = MeorphisTest11(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: MeorphisTest11) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_11_BASE_URL="http://localhost:5000/from/env"):
            client = MeorphisTest11(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: MeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MeorphisTest11(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MeorphisTest11(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("meorphis_test_11._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/generate").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/generate",
                body=cast(object, dict(prompt="REPLACE_ME")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/generate").mock(return_value=httpx.Response(500))
...
class TestAsyncMeorphisTest11:
    client = AsyncMeorphisTest11(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest11Error):
            client2 = AsyncMeorphisTest11(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMeorphisTest11) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_11_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMeorphisTest11(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMeorphisTest11) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMeorphisTest11(
        ...
        client = AsyncMeorphisTest11(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
